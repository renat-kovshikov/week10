...
app.post("/search", (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?query=${userMovieTitle}&api_key=f4e7aff15bee14e0c9460fa717bbb7a1`;
    let genresUrl = "https://api.themoviedb.org/3/genre/movie/list?api_key=f4e7aff15bee14e0c9460fa717bbb7a1&language=en";
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`http://www.omdbapi.com/?t=${movieToSearch}&apikey=bc403151`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
